...
4. **Start the development server**:
    ...
    ```
**Note:**   
<span style="Font-size: 10px"> Since the Back-End and Front-End are seperated on different folders you may need to install/add packages seperately by changing the directory to that folder.</span>  
---
