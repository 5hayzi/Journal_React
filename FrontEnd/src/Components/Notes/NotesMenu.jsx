    ...
    <>
      <div className="dark:bg-gray-800 h-full overflow-hidden">
        ...
        <div className="w-full h-[90%] flex flex-col px-4 relative">
          <span className="text-black text-4xl font-bold font-montserrat dark:text-[#dddddd] py-2 self-center">
            Notes Menu
          </span>
            ...
            <div className="w-11/12 flex flex-row justify-between items-center">
              <div className="w-2/4 h-10 bg-white flex flex-row gap-1 rounded p-1 sm:w-3/4 dark:bg-[#3a3a3a]">
                <label htmlFor="search_box" className="flex">
                  <MagnifyingGlassIcon className="fill-black w-6 dark:fill-white" />
                </label>
                <input
                  type="text"
                  className="w-full h-full border-l border-gray-200 px-2 dark:bg-[#3a3a3a] dark:border-[#868686] dark:placeholder:text-[#dadada] dark:text-white"
                  placeholder="Search"
                  value={search}
        ...
        focus-visible:ring-slate-300"
            ...
            <div className="h-full w-full flex flex-col items-center overflow-y-scroll ">
              {data == "" ? (
                <span className="text-3xl font-montserrat dark:text-[#a5a5a5] my-auto sm:text-xl">
                  Add some pages to your diary
                </span>
              ) : (
