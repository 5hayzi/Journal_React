    ...
    <>
      <div className="relative main-div dark:bg-gray-800 " id="main-div">
        <img
          ...
          className="w-full h-[135%] absolute top-0 sm:hidden"
        />
        <img
          src="src\assets\Images\books-background.png"
          className="w-full absolute bottom-0 hidden sm:flex"
        />
        <NavBar />
        <div className="root-div ">
          <TypeAnimation
            ...
            repeat={Infinity}
          />
          <h2 className="description dark:text-white">
            Create your very own journal with all your notes synced seamlessly
            across all devices.
          </h2>
          <div className="btn-box">
            ...
            <button
              className="btn feature-btn bg-slate-400"
              onClick={() => {
                const features = document.getElementById("feature-div");
                document.getElementById("root").scrollTo({
                  top: features.offsetTop - 100,
                  behavior: "smooth",
                });
              }}
            >
      ...
      <div className="w-full h-[400%] flex flex-col font-montserrat dark:bg-gray-800">
        ...
        <AboutSection />
        <button
          className="w-11 h-[3.4rem] rounded-full bg-black mb-[1%] bg-opacity-80 sticky bottom-[1%] left-[96%] z-10 sm:sticky sm:bottom-[2%] sm:left-[88%] dark:bg-gray-300 sm:h-[3.6rem] "
          onClick={() => {
